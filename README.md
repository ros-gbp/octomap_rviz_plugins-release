## octomap_rviz_plugins (noetic) - 0.2.4-1

The packages in the `octomap_rviz_plugins` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic octomap_rviz_plugins` on `Tue, 21 Dec 2021 19:00:29 -0000`
...
## octomap_rviz_plugins (melodic) - 0.2.4-2
